...
<div class="container">
    ...
    <div class="card card-body">
        ...
        <form action="index.php?c=citas&f=new" method="POST" name="formCitaNuevo" id="formCitaNuevo">
            <div class="form-row">
                <div class="form-group col-sm-6">
                    <label for="nombre">Nombres</label>
                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombres del Paciente"
                        required>
                </div>
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="date" name="fecha" id="fecha" class="form-control" placeholder="Fecha de la Consulta"
                        required>
                </div>
